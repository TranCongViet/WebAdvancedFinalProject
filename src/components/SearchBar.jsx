...
export function SearchBar() {
    ...
    return (
        <form className="container mx-auto py-4 px-4" onSubmit={handleSearch}>
            ...
            <div className="relative">
                ...
                <input
                    type="search"
                    id="default-search"
                    className="block w-full p-4 ps-10 text-sm text-gray-900 rounded-lg bg-gray-50 outline-none"
                    placeholder="Search ..."
                    value={query}
